...
export const getAvailableChatModelProvidersFrontend = async () => {
  const openAIApiKey = "fakekey";
  const groqApiKey = "fakekey";
...
export const getAvailableEmbeddingModelProvidersFrontend = async () => {
  const openAIApiKey = "fakekey";
  const ollamaEndpoint = getOllamaApiEndpoint();
